...
const Home = () => {
  return (
    <div className='w-screen font-TASA-Orbiter -mt-[5%]'>
      <div id="sec-1" className='bg-[#F5E5D7] pt-[10%] overflow-hidden h-[110vh] w-full flex items-center justify-center gap-[5vw]'>
